...
public class AdapterUsuario extends RecyclerView.Adapter<AdapterUsuario.ViewHolder> implements View.OnClickListener {
    ...
    private ArrayList<ModeloUsuarios> userArrayList;
    ...
    public AdapterUsuario(Context context, ArrayList<ModeloUsuarios> model) {
    ...
    {
        ModeloUsuarios user=userArrayList.get(position);


        holder.textView.setText(user.getUsuario());
        holder.textView2.setText(user.getTipo_Usuario());
        holder.textView3.setText(user.getMovil());
/*
